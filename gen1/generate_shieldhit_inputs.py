...
SAVE_DATA_LOCATION = "/home/michal/slrm/gen1"
if os.getenv("PLG_GROUPS_STORAGE"):
    SAVE_DATA_LOCATION = os.environ["PLG_GROUPS_STORAGE"] + "/plggccbmc/mgodek/gen1"
    HOME = "/net/people/plgrid/plgmichalgodek/workspace/ai-proton-simulations/gen1"


os.chdir(f"{HOME}")

Path(SAVE_DATA_LOCATION).mkdir(exist_ok=True)
...
energies = [e for e in range(20, 131, 1)]
